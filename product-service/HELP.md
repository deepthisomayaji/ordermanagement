...
* The original package name 'net.javaguides.springboot-rabbitmq-service' is invalid and this project uses 'net.javaguides.springbootrabbitmqservice' instead.
...
* [Spring for RabbitMQ](https://docs.spring.io/spring-boot/docs/3.1.0-SNAPSHOT/reference/htmlsingle/#messaging.amqp)
